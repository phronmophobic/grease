...
void set_main_view(MembraneView *view) { _clj_main_view = view; }

void *clj_main_view() { return (__bridge void *)_clj_main_view; }
...
operation_t clj_get_generic_callback_address() { return &clj_generic_callback; }

double xAcceleration(CMAccelerometerData *data) { return data.acceleration.x; }
double yAcceleration(CMAccelerometerData *data) { return data.acceleration.y; }
double zAcceleration(CMAccelerometerData *data) { return data.acceleration.z; }
